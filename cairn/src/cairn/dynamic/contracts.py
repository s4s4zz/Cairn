...
# Authorization probe: a 2xx that looks like a login page, or a status that is
# neither a clear denial nor a clear success, cannot settle reachability.
REASON_LOGIN_RESPONSE = "PROBE_LOGIN_RESPONSE"
REASON_RESPONSE_UNCLEAR = "PROBE_RESPONSE_UNCLEAR"
